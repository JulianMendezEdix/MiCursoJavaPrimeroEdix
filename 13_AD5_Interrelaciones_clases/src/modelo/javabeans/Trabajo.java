...
public class Trabajo {
	...
	public static final String CONSTANTE_DE_CLASE = "Esta es una constante de clase";
	
	public Trabajo () {
		super();
	}
	
	public Trabajo (String idTrabajo, String descripcion,
					double minSalario, double maxSalario) {
		super();
